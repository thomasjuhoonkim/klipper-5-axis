...
SOURCE_FILES = [
    ...
    'kin_cartesian.c', 'kin_corexy.c', 'kin_rotuw.c', 'kin_corexz.c',
    'kin_delta.c', 'kin_deltesian.c', 'kin_polar.c', 'kin_rotary_delta.c',
...
defs_itersolve = """
    ...
    double itersolve_calc_position_from_coord(struct stepper_kinematics *sk
        , double x, double y, double z, double u, double w);
...
defs_trapq = """
    ...
    void trapq_append(struct trapq *tq, double print_time
        ...
        , double start_w, double cruise_v, double accel);
    void trapq_finalize_moves(struct trapq *tq, double print_time
        , double clear_history_time);
    void trapq_set_position(struct trapq *tq, double print_time
        , double pos_x, double pos_y, double pos_z, double pos_u, double pos_w);
...
defs_all = [
    ...
    defs_kin_cartesian, defs_kin_corexy, defs_kin_rotuw, defs_kin_corexz,
    defs_kin_delta, defs_kin_deltesian, defs_kin_polar, defs_kin_rotary_delta,
